...
const personas: Record<string, PersonaData> = {
  ENFJ: {
    ...
    opening: '你属于典型的主动压制型，极具压迫感，擅长用先制立直和气场把全桌拖入你的节奏。',
  ...
  ENFP: {
    ...
    opening: '你是不可预测的高波动进攻者，对高打点和名场面有强烈追求，常能在绝境中找出最激进的突破口。',
  ...
  ENTJ: {
    ...
    opening: '你是典型的控场统筹型，控盘无情，意志如铁。你的每一手牌都在压缩对手的生存空间。',
  ...
  ENTP: {
    ...
    opening: '你是明显的大牌追求者，对高打点的执念超越了一切。你在牌桌上追求的不只是赢，更是有记忆点的胜利。',
  ...
  ESFJ: {
    ...
    opening: '你是极致的快攻执行者，擅长用高效率的和牌频率不断压缩对手的展开空间。',
  ...
  ESFP: {
    ...
    opening: '你是战局里机会感最敏锐的追击者。局势的任何松动和缝隙，都会成为你立刻跟进的契机。',
  ...
  ESTJ: {
    ...
    quote: '我没有情绪，我只有盈亏比。',
    opening: '你是以期望值为核心的计算决策型。你用冷静的数字判断，把那些靠感觉打牌的人一步步逼入下风。',
  ...
  ESTP: {
    ...
    opening: '你是典型的连庄推进型。在顺风局里，你能把小优势滚成让全场难受的雪球。',
  ...
  INFJ: {
    ...
    opening: '你是偏重长线布局的类型，重视牌姿的内在逻辑和长线发育，能在无声无息中完成致命染手。',
  ...
  INFP: {
    ...
    opening: '你更像后程潜伏者，不喜欢正面硬刚，但对残局和河底机会有着近乎执着的敏感。',
  ...
  INTJ: {
    ...
    opening: '你是极度重视门清质量的规划型选手。把手牌深藏在暗处，用完整的系统和逻辑一步步逼死对手。',
  ...
  INTP: {
    ...
    opening: '你对局面的收束有着极度冷静的敏感。当残局到来，你会精准地剪断大多数变数。',
  ...
  ISFJ: {
    ...
    opening: '你有很强的牌河分析能力，会把全桌的出牌当作证据，常能在对手听牌前就看出危险信号。',
  ...
  ISFP: {
    ...
    opening: '你把安牌和退路看得很重。无论局势多顺，你都会为自己留一块不容易被击穿的安全空间。',
  ...
  ISTJ: {
    ...
    opening: '你是典型的止损防御型，止损理解极深，能在对手最猛烈的火力下找到最安全的缝隙。',
  ...
  ISTP: {
    ...
    opening: '你对向听数和巡目的敏感达到了机械程度，擅长把乱局拖入自己更擅长的精密节奏。',
